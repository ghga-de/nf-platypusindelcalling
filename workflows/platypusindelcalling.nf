...
//
    ...
    PLATYPUS_RUNNER(sample_ch.withcontrol, sample_ch.nocontrol)

    vcf_ch_withcontrol = PLATYPUS_RUNNER.out.ch_vcf_withcontrol
    vcf_ch_nocontrol = PLATYPUS_RUNNER.out.ch_vcf_nocontrol
...
//    SUBWORKFLOW: INDEL_ANNOTATION
    PLATYPUSINDELANNOTATION(vcf_ch_withcontrol,vcf_ch_nocontrol, sample_ch.withcontrol, sample_ch.nocontrol)
...
//    ch_versions=ch_versions.mix(PLATYPUSINDELANNOTATION.out.annovar_version)
    vcf_ch_withcontrol=PLATYPUSINDELANNOTATION.out.withcontrol_vcf_ch
    vcf_ch_nocontrol=PLATYPUSINDELANNOTATION.out.nocontrol_vcf_ch
