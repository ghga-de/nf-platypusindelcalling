...
process PLATYPUS_NOCONTROL {
    ...
    output:
    tuple val(sample), path('*.platypus.nocontrol.vcf')                      , emit: nocontrol_vcf
    tuple val(sample), path('*.platypus.nocontrol.log')                      , emit: platypus_log
    ...
    def out_vcf = "${sample}.platypus.nocontrol.vcf"
    def out_log = "${sample}.platypus.nocontrol.log"
