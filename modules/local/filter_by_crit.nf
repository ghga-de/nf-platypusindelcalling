...
process FILTER_BY_CRIT {
    ...
    def filter_values = [ (params.filter_exac && params.crit_exac_maxmaf) ? "ExAC AF $params.crit_exac_maxmaf+": "",
                        ...
                        (params.filter_genomad_genomes && params.crit_gnomad_genomes_maxmaf) ? "GNOMAD_GENOMES AF $crit_gnomad_genomes_maxmaf+": "",
                        (params.filter_genomad_exomes && params.crit_gnomad_exomes_maxmaf) ? "GNOMAD_EXOMES AF $crit_gnomad_exomes_maxmaf+": "",
